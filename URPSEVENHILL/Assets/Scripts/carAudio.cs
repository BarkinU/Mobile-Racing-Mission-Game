...
using Random = UnityEngine.Random;
    ...
    public class carAudio : MonoBehaviour
    {
        ...
        // idling : The engine at low revs, with throttle open (i.e. begining acceleration at very low speed)
        // highAccelClip : Thenengine at high revs, with throttle open (i.e. accelerating, but almost at max speed)*** SADECE SIMPLE ICIN KULLANILIYOR ***
        ...
        public AudioClip idling;                                              // Audio clip for low acceleratio
        public AudioClip lowDecelClip;                                              // Audio clip for low deceleration
        public AudioClip highAccelClip;                                             // Audio clip for high acceleration*** SADECE SIMPLE ICIN KULLANILIYOR ***
        ...
        private AudioSource m_HighAccel; // Source for the high acceleration sounds *** SADECE SIMPLE ICIN KULLANILIYOR ***
        private AudioSource m_HighDecel; // Source for the high deceleration sounds
        private bool m_StartedSound; // flag for knowing if we have started sounds
        //private CarController m_CarController; // Reference to car we are controlling
        public PABLO m_CarController;
        void Start(){
                StartSound();
                m_CarController = GameObject.FindGameObjectWithTag("Player").GetComponent<PABLO>();

        }
        private void StartSound()
        {
            // get the carcontroller ( this will not be null as we have require component)
            // m_CarController = GetComponent<PABLO>();
            ...
            {
                m_LowAccel = SetUpEngineAudioSource(idling);
    ...
    private void FixedUpdate()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, m_CarController.engineRPM*1.2f / m_CarController.maxRPM);
